...
public class FilesCommentsDeleteResponse implements SlackApiResponse {
    ...
    public FilesCommentsDeleteResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FilesCommentsDeleteResponse))
            return false;
        final FilesCommentsDeleteResponse other = (FilesCommentsDeleteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FilesCommentsDeleteResponse;
    }
    ...
    public String toString() {
        return "FilesCommentsDeleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}