...
public class UsergroupsCreateResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsergroupsCreateResponse))
            return false;
        final UsergroupsCreateResponse other = (UsergroupsCreateResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsergroupsCreateResponse;
    }
    ...
    public String toString() {
        return "UsergroupsCreateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", usergroup=" + this.getUsergroup() + ")";
    }
}