...
public class UsersSetActiveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersSetActiveResponse)) return false;
        final UsersSetActiveResponse other = (UsersSetActiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersSetActiveResponse;
    }
    ...
    public String toString() {
        return "UsersSetActiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}