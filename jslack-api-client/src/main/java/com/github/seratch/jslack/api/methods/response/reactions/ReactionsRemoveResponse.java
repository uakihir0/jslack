...
public class ReactionsRemoveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ReactionsRemoveResponse))
            return false;
        final ReactionsRemoveResponse other = (ReactionsRemoveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ReactionsRemoveResponse;
    }
    ...
    public String toString() {
        return "ReactionsRemoveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}