...
public class GroupsCreateResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsCreateResponse)) return false;
        final GroupsCreateResponse other = (GroupsCreateResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsCreateResponse;
    }
    ...
    public String toString() {
        return "GroupsCreateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", group=" + this.getGroup() + ")";
    }
}