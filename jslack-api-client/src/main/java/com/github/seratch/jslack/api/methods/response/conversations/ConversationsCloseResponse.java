...
public class ConversationsCloseResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsCloseResponse))
            return false;
        final ConversationsCloseResponse other = (ConversationsCloseResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsCloseResponse;
    }
    ...
    public String toString() {
        return "ConversationsCloseResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
