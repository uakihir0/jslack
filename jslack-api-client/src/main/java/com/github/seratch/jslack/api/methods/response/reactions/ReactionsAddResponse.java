...
public class ReactionsAddResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ReactionsAddResponse)) return false;
        final ReactionsAddResponse other = (ReactionsAddResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ReactionsAddResponse;
    }
    ...
    public String toString() {
        return "ReactionsAddResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}