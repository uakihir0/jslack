...
public class ConversationsJoinResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsJoinResponse))
            return false;
        final ConversationsJoinResponse other = (ConversationsJoinResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsJoinResponse;
    }
    ...
    public String toString() {
        return "ConversationsJoinResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
