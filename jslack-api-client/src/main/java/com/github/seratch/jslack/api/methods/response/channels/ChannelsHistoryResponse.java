...
public class ChannelsHistoryResponse implements SlackApiResponse {
    ...
    public ChannelsHistoryResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsHistoryResponse))
            return false;
        final ChannelsHistoryResponse other = (ChannelsHistoryResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsHistoryResponse;
    }
    ...
    public String toString() {
        return "ChannelsHistoryResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", latest=" + this.getLatest() + ", messages=" + this.getMessages() + ", hasMore=" + this.isHasMore() + ")";
    }
}
