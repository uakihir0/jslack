...
public class TeamProfileGetResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TeamProfileGetResponse))
            return false;
    ...
    public String toString() {
        return "TeamProfileGetResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", profile=" + this.getProfile() + ")";
    }
