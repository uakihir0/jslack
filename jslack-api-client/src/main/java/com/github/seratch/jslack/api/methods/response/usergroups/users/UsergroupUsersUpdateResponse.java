...
public class UsergroupUsersUpdateResponse implements SlackApiResponse {
    ...
    public UsergroupUsersUpdateResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsergroupUsersUpdateResponse))
            return false;
        final UsergroupUsersUpdateResponse other = (UsergroupUsersUpdateResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsergroupUsersUpdateResponse;
    }
    ...
    public String toString() {
        return "UsergroupUsersUpdateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", usergroup=" + this.getUsergroup() + ")";
    }
}