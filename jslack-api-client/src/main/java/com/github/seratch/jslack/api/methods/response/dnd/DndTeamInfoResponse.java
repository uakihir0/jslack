...
public class DndTeamInfoResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "DndTeamInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", users=" + this.getUsers() + ")";
    }
