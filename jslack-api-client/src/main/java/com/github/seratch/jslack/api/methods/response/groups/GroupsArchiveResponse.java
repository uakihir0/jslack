...
public class GroupsArchiveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsArchiveResponse)) return false;
        final GroupsArchiveResponse other = (GroupsArchiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsArchiveResponse;
    }
    ...
    public String toString() {
        return "GroupsArchiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}