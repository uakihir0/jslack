...
public class ConversationsListResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ConversationsListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channels=" + this.getChannels() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
