...
public class ChatDeleteScheduledMessageResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChatDeleteScheduledMessageResponse))
            return false;
        final ChatDeleteScheduledMessageResponse other = (ChatDeleteScheduledMessageResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChatDeleteScheduledMessageResponse;
    }
    ...
    public String toString() {
        return "ChatDeleteScheduledMessageResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}