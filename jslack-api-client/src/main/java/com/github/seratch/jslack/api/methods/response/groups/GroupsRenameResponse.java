...
public class GroupsRenameResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "GroupsRenameResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}