...
public class GroupsInviteResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "GroupsInviteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", group=" + this.getGroup() + ")";
    }
}