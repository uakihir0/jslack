...
public class GroupsSetPurposeResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsSetPurposeResponse))
            return false;
    ...
    public String toString() {
        return "GroupsSetPurposeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", purpose=" + this.getPurpose() + ")";
    }
}