...
public class ConversationsUnarchiveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsUnarchiveResponse))
            return false;
        final ConversationsUnarchiveResponse other = (ConversationsUnarchiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsUnarchiveResponse;
    }
    ...
    public String toString() {
        return "ConversationsUnarchiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
