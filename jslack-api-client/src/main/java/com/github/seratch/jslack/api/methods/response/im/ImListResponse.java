...
public class ImListResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ImListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", ims=" + this.getIms() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
