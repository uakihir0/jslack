...
public class ChatUnfurlResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChatUnfurlResponse)) return false;
        final ChatUnfurlResponse other = (ChatUnfurlResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChatUnfurlResponse;
    }
    ...
    public String toString() {
        return "ChatUnfurlResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
