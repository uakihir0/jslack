...
public class SlackApiErrorResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SlackApiErrorResponse)) return false;
        final SlackApiErrorResponse other = (SlackApiErrorResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SlackApiErrorResponse;
    }
    ...
    public String toString() {
        return "SlackApiErrorResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
