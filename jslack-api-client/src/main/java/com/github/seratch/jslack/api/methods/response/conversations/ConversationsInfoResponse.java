...
public class ConversationsInfoResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsInfoResponse))
            return false;
        final ConversationsInfoResponse other = (ConversationsInfoResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsInfoResponse;
    }
    ...
    public String toString() {
        return "ConversationsInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
