...
public class PinsAddResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PinsAddResponse)) return false;
        final PinsAddResponse other = (PinsAddResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PinsAddResponse;
    }
    ...
    public String toString() {
        return "PinsAddResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}