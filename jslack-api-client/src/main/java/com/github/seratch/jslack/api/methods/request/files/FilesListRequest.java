...
public class FilesListRequest implements SlackApiRequest {
    ...
    public boolean equals(final Object o) {
        ...
        if (this.isShowFilesHiddenByLimit() != other.isShowFilesHiddenByLimit()) return false;
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME + (this.isShowFilesHiddenByLimit() ? 79 : 97);
        return result;
    }

    public String toString() {
        return "FilesListRequest(token=" + this.getToken() + ", user=" + this.getUser() + ", channel=" + this.getChannel() + ", tsFrom=" + this.getTsFrom() + ", tsTo=" + this.getTsTo() + ", types=" + this.getTypes() + ", count=" + this.getCount() + ", page=" + this.getPage() + ", showFilesHiddenByLimit=" + this.isShowFilesHiddenByLimit() + ")";
    }
