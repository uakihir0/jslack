...
public class GroupsRepliesResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsRepliesResponse)) return false;
        final GroupsRepliesResponse other = (GroupsRepliesResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsRepliesResponse;
    }
    ...
    public String toString() {
        return "GroupsRepliesResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", messages=" + this.getMessages() + ", threadInfo=" + this.getThreadInfo() + ", hasMore=" + this.isHasMore() + ")";
    }
}
