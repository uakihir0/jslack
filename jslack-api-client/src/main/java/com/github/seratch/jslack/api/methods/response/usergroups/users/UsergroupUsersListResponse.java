...
public class UsergroupUsersListResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsergroupUsersListResponse))
            return false;
    ...
    public String toString() {
        return "UsergroupUsersListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", users=" + this.getUsers() + ")";
    }
}