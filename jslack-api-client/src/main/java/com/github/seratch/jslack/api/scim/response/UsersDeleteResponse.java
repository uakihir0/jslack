...
public class UsersDeleteResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersDeleteResponse)) return false;
        final UsersDeleteResponse other = (UsersDeleteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersDeleteResponse;
    }
    ...
    public String toString() {
        return "UsersDeleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
