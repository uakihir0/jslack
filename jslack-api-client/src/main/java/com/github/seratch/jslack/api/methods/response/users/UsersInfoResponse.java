...
public class UsersInfoResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersInfoResponse)) return false;
        final UsersInfoResponse other = (UsersInfoResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersInfoResponse;
    }
    ...
    public String toString() {
        return "UsersInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", user=" + this.getUser() + ")";
    }
}