...
public class ChannelsCreateResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsCreateResponse))
            return false;
        final ChannelsCreateResponse other = (ChannelsCreateResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsCreateResponse;
    }
    ...
    public String toString() {
        return "ChannelsCreateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
