...
public class ConversationsSetPurposeResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsSetPurposeResponse))
            return false;
        final ConversationsSetPurposeResponse other = (ConversationsSetPurposeResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsSetPurposeResponse;
    }
    ...
    public String toString() {
        return "ConversationsSetPurposeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
