...
public class UsersSetPresenceResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersSetPresenceResponse)) return false;
        final UsersSetPresenceResponse other = (UsersSetPresenceResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersSetPresenceResponse;
    }
    ...
    public String toString() {
        return "UsersSetPresenceResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}