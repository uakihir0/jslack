...
public class UsersLookupByEmailResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersLookupByEmailResponse))
            return false;
        final UsersLookupByEmailResponse other = (UsersLookupByEmailResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersLookupByEmailResponse;
    }
    ...
    public String toString() {
        return "UsersLookupByEmailResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", user=" + this.getUser() + ")";
    }
}
