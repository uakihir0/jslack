...
public class PinsRemoveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PinsRemoveResponse)) return false;
        final PinsRemoveResponse other = (PinsRemoveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PinsRemoveResponse;
    }
    ...
    public String toString() {
        return "PinsRemoveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}