...
public class ConversationsInviteResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsInviteResponse))
            return false;
        final ConversationsInviteResponse other = (ConversationsInviteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsInviteResponse;
    }
    ...
    public String toString() {
        return "ConversationsInviteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", errors=" + this.getErrors() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
    ...
    public static class Error {
        ...
        public String toString() {
            return "ConversationsInviteResponse.Error(ok=" + this.isOk() + ", error=" + this.getError() + ")";
        }
    }
}
