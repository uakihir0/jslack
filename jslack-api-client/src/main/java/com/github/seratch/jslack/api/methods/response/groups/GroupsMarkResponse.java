...
public class GroupsMarkResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsMarkResponse)) return false;
        final GroupsMarkResponse other = (GroupsMarkResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsMarkResponse;
    }
    ...
    public String toString() {
        return "GroupsMarkResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}