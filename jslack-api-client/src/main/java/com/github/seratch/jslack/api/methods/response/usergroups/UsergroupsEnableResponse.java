...
public class UsergroupsEnableResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsergroupsEnableResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", usergroup=" + this.getUsergroup() + ")";
    }
}