...
public class GroupsSetTopicResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "GroupsSetTopicResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", topic=" + this.getTopic() + ")";
    }
}