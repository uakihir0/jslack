...
public class FilesCommentsEditResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FilesCommentsEditResponse))
            return false;
    ...
    public String toString() {
        return "FilesCommentsEditResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", comment=" + this.getComment() + ")";
    }
}