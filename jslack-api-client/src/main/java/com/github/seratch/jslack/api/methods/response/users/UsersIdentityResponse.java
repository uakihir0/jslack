...
public class UsersIdentityResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsersIdentityResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", user=" + this.getUser() + ", team=" + this.getTeam() + ")";
    }
