...
public class ConversationsSetTopicResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsSetTopicResponse))
            return false;
        final ConversationsSetTopicResponse other = (ConversationsSetTopicResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsSetTopicResponse;
    }
    ...
    public String toString() {
        return "ConversationsSetTopicResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
