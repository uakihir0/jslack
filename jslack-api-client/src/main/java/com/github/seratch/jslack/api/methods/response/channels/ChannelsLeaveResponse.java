...
public class ChannelsLeaveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsLeaveResponse)) return false;
        final ChannelsLeaveResponse other = (ChannelsLeaveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsLeaveResponse;
    }
    ...
    public String toString() {
        return "ChannelsLeaveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", notInChannel=" + this.isNotInChannel() + ")";
    }
}
