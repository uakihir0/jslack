...
public class AppsPermissionsUsersRequestResponse implements SlackApiResponse {
    ...
    public AppsPermissionsUsersRequestResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AppsPermissionsUsersRequestResponse))
            return false;
        final AppsPermissionsUsersRequestResponse other = (AppsPermissionsUsersRequestResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AppsPermissionsUsersRequestResponse;
    }
    ...
    public String toString() {
        return "AppsPermissionsUsersRequestResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}