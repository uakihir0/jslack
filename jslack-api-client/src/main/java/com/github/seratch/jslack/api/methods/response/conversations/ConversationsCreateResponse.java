...
public class ConversationsCreateResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsCreateResponse))
            return false;
        final ConversationsCreateResponse other = (ConversationsCreateResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsCreateResponse;
    }
    ...
    public String toString() {
        return "ConversationsCreateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
