...
public class MpimCloseResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MpimCloseResponse)) return false;
        final MpimCloseResponse other = (MpimCloseResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MpimCloseResponse;
    }
    ...
    public String toString() {
        return "MpimCloseResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}