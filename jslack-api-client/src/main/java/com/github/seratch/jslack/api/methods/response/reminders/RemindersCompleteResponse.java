...
public class RemindersCompleteResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RemindersCompleteResponse))
            return false;
        final RemindersCompleteResponse other = (RemindersCompleteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemindersCompleteResponse;
    }
    ...
    public String toString() {
        return "RemindersCompleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}