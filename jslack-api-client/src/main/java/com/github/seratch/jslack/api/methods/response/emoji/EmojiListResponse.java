...
public class EmojiListResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "EmojiListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", emoji=" + this.getEmoji() + ", cacheTs=" + this.getCacheTs() + ")";
    }
}