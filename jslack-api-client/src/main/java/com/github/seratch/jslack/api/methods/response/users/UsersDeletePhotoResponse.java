...
public class UsersDeletePhotoResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsersDeletePhotoResponse)) return false;
        final UsersDeletePhotoResponse other = (UsersDeletePhotoResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsersDeletePhotoResponse;
    }
    ...
    public String toString() {
        return "UsersDeletePhotoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
