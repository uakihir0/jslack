...
public class ChannelsJoinResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsJoinResponse)) return false;
        final ChannelsJoinResponse other = (ChannelsJoinResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsJoinResponse;
    }
    ...
    public String toString() {
        return "ChannelsJoinResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
