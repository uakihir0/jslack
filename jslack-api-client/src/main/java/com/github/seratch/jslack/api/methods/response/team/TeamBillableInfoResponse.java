...
public class TeamBillableInfoResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "TeamBillableInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", billableInfo=" + this.getBillableInfo() + ")";
    }
}