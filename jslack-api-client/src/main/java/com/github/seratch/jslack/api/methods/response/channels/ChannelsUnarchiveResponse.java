...
public class ChannelsUnarchiveResponse implements SlackApiResponse {
    ...
    public ChannelsUnarchiveResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsUnarchiveResponse))
            return false;
        final ChannelsUnarchiveResponse other = (ChannelsUnarchiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsUnarchiveResponse;
    }
    ...
    public String toString() {
        return "ChannelsUnarchiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
