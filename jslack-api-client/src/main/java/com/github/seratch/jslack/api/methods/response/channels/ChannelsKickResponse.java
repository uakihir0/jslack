...
public class ChannelsKickResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsKickResponse)) return false;
        final ChannelsKickResponse other = (ChannelsKickResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsKickResponse;
    }
    ...
    public String toString() {
        return "ChannelsKickResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
