...
public class AppsPermissionsResourcesListResponse implements SlackApiResponse {
    ...
    public AppsPermissionsResourcesListResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AppsPermissionsResourcesListResponse))
            return false;
        final AppsPermissionsResourcesListResponse other = (AppsPermissionsResourcesListResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AppsPermissionsResourcesListResponse;
    }
    ...
    public String toString() {
        return "AppsPermissionsResourcesListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", resources=" + this.getResources() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
    ...
    public static class Resource {
        ...
        public String toString() {
            return "AppsPermissionsResourcesListResponse.Resource(id=" + this.getId() + ", type=" + this.getType() + ")";
        }
    }
