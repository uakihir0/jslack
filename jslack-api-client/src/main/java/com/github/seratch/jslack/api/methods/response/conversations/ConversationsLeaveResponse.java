...
public class ConversationsLeaveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsLeaveResponse))
            return false;
    ...
    public String toString() {
        return "ConversationsLeaveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", notInChannel=" + this.isNotInChannel() + ")";
    }
}
