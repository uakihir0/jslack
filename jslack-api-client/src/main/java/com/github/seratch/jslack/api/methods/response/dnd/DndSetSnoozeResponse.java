...
public class DndSetSnoozeResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "DndSetSnoozeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", snoozeEnabled=" + this.isSnoozeEnabled() + ", snoozeEndtime=" + this.getSnoozeEndtime() + ", snoozeRemaining=" + this.getSnoozeRemaining() + ")";
    }
}