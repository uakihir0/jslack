...
public class UsersGetPresenceResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsersGetPresenceResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", presence=" + this.getPresence() + ", online=" + this.isOnline() + ", autoAway=" + this.isAutoAway() + ", manualAway=" + this.isManualAway() + ", connectionCount=" + this.getConnectionCount() + ", lastActivity=" + this.getLastActivity() + ")";
    }
}