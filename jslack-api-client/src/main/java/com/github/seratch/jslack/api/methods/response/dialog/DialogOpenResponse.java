...
public class DialogOpenResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "DialogOpenResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
