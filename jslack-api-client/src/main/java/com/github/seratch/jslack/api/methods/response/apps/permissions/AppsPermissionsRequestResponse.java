...
public class AppsPermissionsRequestResponse implements SlackApiResponse {
    ...
    public AppsPermissionsRequestResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AppsPermissionsRequestResponse))
            return false;
        final AppsPermissionsRequestResponse other = (AppsPermissionsRequestResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AppsPermissionsRequestResponse;
    }
    ...
    public String toString() {
        return "AppsPermissionsRequestResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}