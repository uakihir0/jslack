...
public class ConversationsMembersResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsMembersResponse))
            return false;
    ...
    public String toString() {
        return "ConversationsMembersResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", members=" + this.getMembers() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
