...
public class GroupsCreateChildResponse implements SlackApiResponse {
    ...
    public GroupsCreateChildResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsCreateChildResponse))
            return false;
        final GroupsCreateChildResponse other = (GroupsCreateChildResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsCreateChildResponse;
    }
    ...
    public String toString() {
        return "GroupsCreateChildResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", group=" + this.getGroup() + ")";
    }
}