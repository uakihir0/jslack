...
public class ChannelsSetPurposeResponse implements SlackApiResponse {
    ...
    public ChannelsSetPurposeResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsSetPurposeResponse))
            return false;
        final ChannelsSetPurposeResponse other = (ChannelsSetPurposeResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsSetPurposeResponse;
    }
    ...
    public String toString() {
        return "ChannelsSetPurposeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", purpose=" + this.getPurpose() + ")";
    }
}
