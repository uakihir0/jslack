...
public class RemindersDeleteResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RemindersDeleteResponse))
            return false;
        final RemindersDeleteResponse other = (RemindersDeleteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemindersDeleteResponse;
    }
    ...
    public String toString() {
        return "RemindersDeleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}