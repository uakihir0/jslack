...
public class ChatGetPermalinkResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ChatGetPermalinkResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ", permalink=" + this.getPermalink() + ")";
    }
}
