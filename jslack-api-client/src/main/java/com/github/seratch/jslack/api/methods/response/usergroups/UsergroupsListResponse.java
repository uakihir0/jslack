...
public class UsergroupsListResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsergroupsListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", usergroups=" + this.getUsergroups() + ")";
    }
}