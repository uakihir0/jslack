...
public class ChannelsInfoResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsInfoResponse)) return false;
        final ChannelsInfoResponse other = (ChannelsInfoResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsInfoResponse;
    }
    ...
    public String toString() {
        return "ChannelsInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
