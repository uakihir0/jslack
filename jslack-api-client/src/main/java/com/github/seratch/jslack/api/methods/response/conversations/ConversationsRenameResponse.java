...
public class ConversationsRenameResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ConversationsRenameResponse))
            return false;
        final ConversationsRenameResponse other = (ConversationsRenameResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ConversationsRenameResponse;
    }
    ...
    public String toString() {
        return "ConversationsRenameResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ")";
    }
}
