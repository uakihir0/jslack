...
public class SearchFilesResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "SearchFilesResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", query=" + this.getQuery() + ", files=" + this.getFiles() + ")";
    }
}