...
public class ImOpenResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ImOpenResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", noOp=" + this.isNoOp() + ", alreadyOpen=" + this.isAlreadyOpen() + ", channel=" + this.getChannel() + ")";
    }
}