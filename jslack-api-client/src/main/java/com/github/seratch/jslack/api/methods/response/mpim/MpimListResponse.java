...
public class MpimListResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MpimListResponse)) return false;
        final MpimListResponse other = (MpimListResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MpimListResponse;
    }
    ...
    public String toString() {
        return "MpimListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", groups=" + this.getGroups() + ")";
    }
}