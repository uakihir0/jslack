...
public class MpimRepliesResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MpimRepliesResponse)) return false;
        final MpimRepliesResponse other = (MpimRepliesResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MpimRepliesResponse;
    }
    ...
    public String toString() {
        return "MpimRepliesResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", messages=" + this.getMessages() + ")";
    }
}