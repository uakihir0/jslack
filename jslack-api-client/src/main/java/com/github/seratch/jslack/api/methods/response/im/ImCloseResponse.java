...
public class ImCloseResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ImCloseResponse)) return false;
        final ImCloseResponse other = (ImCloseResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ImCloseResponse;
    }
    ...
    public String toString() {
        return "ImCloseResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}