...
public class RemindersListResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RemindersListResponse))
            return false;
    ...
    public String toString() {
        return "RemindersListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", reminders=" + this.getReminders() + ")";
    }
}