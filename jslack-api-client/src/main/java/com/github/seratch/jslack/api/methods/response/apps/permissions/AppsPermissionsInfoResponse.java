...
public class AppsPermissionsInfoResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "AppsPermissionsInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", info=" + this.getInfo() + ")";
    }
