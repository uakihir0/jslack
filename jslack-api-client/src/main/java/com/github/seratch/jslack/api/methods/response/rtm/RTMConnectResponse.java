...
public class RTMConnectResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "RTMConnectResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", url=" + this.getUrl() + ", self=" + this.getSelf() + ", team=" + this.getTeam() + ")";
    }
}
