...
public class MpimHistoryResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MpimHistoryResponse)) return false;
        final MpimHistoryResponse other = (MpimHistoryResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MpimHistoryResponse;
    }
    ...
    public String toString() {
        return "MpimHistoryResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", latest=" + this.getLatest() + ", messages=" + this.getMessages() + ", hasMore=" + this.isHasMore() + ")";
    }
}