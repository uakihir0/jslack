...
public class TeamAccessLogsResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "TeamAccessLogsResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", logins=" + this.getLogins() + ", paging=" + this.getPaging() + ")";
    }
}