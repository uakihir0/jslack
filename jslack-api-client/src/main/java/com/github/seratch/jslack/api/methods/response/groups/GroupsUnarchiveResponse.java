...
public class GroupsUnarchiveResponse implements SlackApiResponse {
    ...
    public GroupsUnarchiveResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsUnarchiveResponse)) return false;
        final GroupsUnarchiveResponse other = (GroupsUnarchiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsUnarchiveResponse;
    }
    ...
    public String toString() {
        return "GroupsUnarchiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}