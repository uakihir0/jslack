...
public class AppsUninstallResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof AppsUninstallResponse)) return false;
        final AppsUninstallResponse other = (AppsUninstallResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AppsUninstallResponse;
    }
    ...
    public String toString() {
        return "AppsUninstallResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}