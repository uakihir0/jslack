...
public class DndEndDndResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DndEndDndResponse)) return false;
        final DndEndDndResponse other = (DndEndDndResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DndEndDndResponse;
    }
    ...
    public String toString() {
        return "DndEndDndResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}