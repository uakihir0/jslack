...
public class UsersSetPhotoResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsersSetPhotoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", profile=" + this.getProfile() + ")";
    }
}
