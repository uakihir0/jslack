...
public class GroupsListResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "GroupsListResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", groups=" + this.getGroups() + ")";
    }
}