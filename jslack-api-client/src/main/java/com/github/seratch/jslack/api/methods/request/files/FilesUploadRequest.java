...
public class FilesUploadRequest implements SlackApiRequest {
    ...
    public String toString() {
        return "FilesUploadRequest(token=" + this.getToken() + ", file=" + this.getFile() + ", content=" + this.getContent() + ", filetype=" + this.getFiletype() + ", filename=" + this.getFilename() + ", title=" + this.getTitle() + ", initialComment=" + this.getInitialComment() + ", channels=" + this.getChannels() + ", threadTs=" + this.getThreadTs() + ")";
    }
    ...
    public static class FilesUploadRequestBuilder {
        ...
        public String toString() {
            return "FilesUploadRequest.FilesUploadRequestBuilder(token=" + this.token + ", file=" + this.file + ", content=" + this.content + ", filetype=" + this.filetype + ", filename=" + this.filename + ", title=" + this.title + ", initialComment=" + this.initialComment + ", channels=" + this.channels + ", threadTs=" + this.threadTs + ")";
        }
    }
}