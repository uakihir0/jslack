...
public class ChannelsSetTopicResponse implements SlackApiResponse {
    ...
    public ChannelsSetTopicResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsSetTopicResponse))
            return false;
        final ChannelsSetTopicResponse other = (ChannelsSetTopicResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsSetTopicResponse;
    }
    ...
    public String toString() {
        return "ChannelsSetTopicResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", topic=" + this.getTopic() + ")";
    }
}
