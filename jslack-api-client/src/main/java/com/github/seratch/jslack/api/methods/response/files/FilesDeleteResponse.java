...
public class FilesDeleteResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FilesDeleteResponse)) return false;
        final FilesDeleteResponse other = (FilesDeleteResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FilesDeleteResponse;
    }
    ...
    public String toString() {
        return "FilesDeleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}