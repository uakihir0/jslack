...
public class ChatPostEphemeralResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ChatPostEphemeralResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ", messageTs=" + this.getMessageTs() + ")";
    }
}