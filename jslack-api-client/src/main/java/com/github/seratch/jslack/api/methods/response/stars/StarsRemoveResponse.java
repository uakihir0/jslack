...
public class StarsRemoveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof StarsRemoveResponse)) return false;
        final StarsRemoveResponse other = (StarsRemoveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof StarsRemoveResponse;
    }
    ...
    public String toString() {
        return "StarsRemoveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}