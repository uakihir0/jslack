...
public class GroupsLeaveResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsLeaveResponse)) return false;
        final GroupsLeaveResponse other = (GroupsLeaveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsLeaveResponse;
    }
    ...
    public String toString() {
        return "GroupsLeaveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}