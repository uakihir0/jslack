...
public class MpimMarkResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof MpimMarkResponse)) return false;
        final MpimMarkResponse other = (MpimMarkResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof MpimMarkResponse;
    }
    ...
    public String toString() {
        return "MpimMarkResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}