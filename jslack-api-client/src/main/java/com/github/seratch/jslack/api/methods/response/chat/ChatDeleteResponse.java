...
public class ChatDeleteResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "ChatDeleteResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", channel=" + this.getChannel() + ", ts=" + this.getTs() + ")";
    }
}