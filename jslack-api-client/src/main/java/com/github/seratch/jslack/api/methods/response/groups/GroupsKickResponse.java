...
public class GroupsKickResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupsKickResponse)) return false;
        final GroupsKickResponse other = (GroupsKickResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupsKickResponse;
    }
    ...
    public String toString() {
        return "GroupsKickResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}