...
public class ChannelsArchiveResponse implements SlackApiResponse {
    ...
    public ChannelsArchiveResponse() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelsArchiveResponse))
            return false;
        final ChannelsArchiveResponse other = (ChannelsArchiveResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelsArchiveResponse;
    }
    ...
    public String toString() {
        return "ChannelsArchiveResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ")";
    }
}
