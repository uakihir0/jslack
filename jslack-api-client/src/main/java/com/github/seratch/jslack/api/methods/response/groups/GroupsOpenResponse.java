...
public class GroupsOpenResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "GroupsOpenResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", noOp=" + this.isNoOp() + ", alreadyOpen=" + this.isAlreadyOpen() + ")";
    }
}