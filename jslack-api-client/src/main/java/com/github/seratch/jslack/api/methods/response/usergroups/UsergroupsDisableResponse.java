...
public class UsergroupsDisableResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UsergroupsDisableResponse))
            return false;
        final UsergroupsDisableResponse other = (UsergroupsDisableResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UsergroupsDisableResponse;
    }
    ...
    public String toString() {
        return "UsergroupsDisableResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", usergroup=" + this.getUsergroup() + ")";
    }
}