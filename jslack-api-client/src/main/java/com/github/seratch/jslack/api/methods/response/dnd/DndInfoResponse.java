...
public class DndInfoResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "DndInfoResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", dndEnabled=" + this.isDndEnabled() + ", nextDndStartTs=" + this.getNextDndStartTs() + ", nextDndEndTs=" + this.getNextDndEndTs() + ", snoozeEnabled=" + this.isSnoozeEnabled() + ", snoozeEndtime=" + this.getSnoozeEndtime() + ", snoozeRemaining=" + this.getSnoozeRemaining() + ")";
    }
}