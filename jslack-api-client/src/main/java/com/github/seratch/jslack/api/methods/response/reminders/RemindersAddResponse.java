...
public class RemindersAddResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof RemindersAddResponse)) return false;
        final RemindersAddResponse other = (RemindersAddResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemindersAddResponse;
    }
    ...
    public String toString() {
        return "RemindersAddResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", reminder=" + this.getReminder() + ")";
    }
}