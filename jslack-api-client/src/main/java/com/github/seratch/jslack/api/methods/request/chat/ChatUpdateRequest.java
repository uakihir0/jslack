...
public class ChatUpdateRequest implements SlackApiRequest {
    ...
    ChatUpdateRequest(String token, String channel, String ts, String text, String user, boolean asUser, List<LayoutBlock> blocks, List<Attachment> attachments, boolean linkNames, String parse) {
        this.token = token;
    ...
    public String toString() {
        return "ChatUpdateRequest(token=" + this.getToken() + ", channel=" + this.getChannel() + ", ts=" + this.getTs() + ", text=" + this.getText() + ", user=" + this.getUser() + ", asUser=" + this.isAsUser() + ", blocks=" + this.getBlocks() + ", attachments=" + this.getAttachments() + ", linkNames=" + this.isLinkNames() + ", parse=" + this.getParse() + ")";
    }
    ...
    public static class ChatUpdateRequestBuilder {
        ...
        public ChatUpdateRequest build() {
            return new ChatUpdateRequest(token, channel, ts, text, user, asUser, blocks, attachments, linkNames, parse);
        }
