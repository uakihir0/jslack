...
public class ConversationsHistoryResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$pinCount = this.getPinCount();
        final Object other$pinCount = other.getPinCount();
        if (this$pinCount == null ? other$pinCount != null : !this$pinCount.equals(other$pinCount)) return false;
    ...
    public int hashCode() {
        ...
        final Object $pinCount = this.getPinCount();
        result = result * PRIME + ($pinCount == null ? 43 : $pinCount.hashCode());
    ...
    public String toString() {
        return "ConversationsHistoryResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", needed=" + this.getNeeded() + ", provided=" + this.getProvided() + ", latest=" + this.getLatest() + ", messages=" + this.getMessages() + ", hasMore=" + this.isHasMore() + ", pinCount=" + this.getPinCount() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
