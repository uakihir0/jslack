...
public class SlackHttpClient {
    ...
    public SlackHttpClient(HttpClientWrapper okHttpClient) {
        this.httpClient = okHttpClient;
    }

//    public HttpResponse postMultipart(String url, String token, MultipartBody multipartBody) throws IOException {
