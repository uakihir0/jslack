...
public class MigrationExchangeResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "MigrationExchangeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", teamId=" + this.getTeamId() + ", enterpriseId=" + this.getEnterpriseId() + ", invalidUserIds=" + this.getInvalidUserIds() + ", userIdMap=" + this.getUserIdMap() + ")";
    }
}