...
public class ChannelsSetTopicResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelsSetTopicResponse)) return false;
    ...
    public String toString() {
        return "ChannelsSetTopicResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", topic=" + this.getTopic() + ")";
    }
}
