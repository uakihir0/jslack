...
public class SearchAllRequest implements SlackApiRequest {
    ...
    public String toString() {
        return "SearchAllRequest(token=" + this.getToken() + ", query=" + this.getQuery() + ", sort=" + this.getSort() + ", sortDir=" + this.getSortDir() + ", highlight=" + this.isHighlight() + ", count=" + this.getCount() + ", page=" + this.getPage() + ")";
    }
