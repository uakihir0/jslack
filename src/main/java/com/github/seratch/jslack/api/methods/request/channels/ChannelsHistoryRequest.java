...
public class ChannelsHistoryRequest implements SlackApiRequest {
    ...
    ChannelsHistoryRequest(String token, String channel, String latest, String oldest, Integer inclusive, Integer count, Integer unreads) {
        this.token = token;
    ...
    public String toString() {
        return "ChannelsHistoryRequest(token=" + this.getToken() + ", channel=" + this.getChannel() + ", latest=" + this.getLatest() + ", oldest=" + this.getOldest() + ", inclusive=" + this.getInclusive() + ", count=" + this.getCount() + ", unreads=" + this.getUnreads() + ")";
    }
    ...
    public static class ChannelsHistoryRequestBuilder {
        ...
        public ChannelsHistoryRequest.ChannelsHistoryRequestBuilder inclusive(Integer inclusive) {
            this.inclusive = inclusive;
            return this;
        }
        ...
        public ChannelsHistoryRequest.ChannelsHistoryRequestBuilder unreads(Integer unreads) {
            this.unreads = unreads;
            return this;
        }
