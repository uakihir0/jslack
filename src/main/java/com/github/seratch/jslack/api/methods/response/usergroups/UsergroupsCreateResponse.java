...
public class UsergroupsCreateResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsergroupsCreateResponse)) return false;
    ...
    public String toString() {
        return "UsergroupsCreateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", usergroup=" + this.getUsergroup() + ")";
    }
}