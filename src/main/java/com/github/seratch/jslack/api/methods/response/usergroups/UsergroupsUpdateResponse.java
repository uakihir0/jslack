...
public class UsergroupsUpdateResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsergroupsUpdateResponse)) return false;
    ...
    public String toString() {
        return "UsergroupsUpdateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", usergroup=" + this.getUsergroup() + ")";
    }
}