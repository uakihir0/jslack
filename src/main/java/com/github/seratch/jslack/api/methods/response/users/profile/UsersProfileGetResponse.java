...
public class UsersProfileGetResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsersProfileGetResponse)) return false;
    ...
    public String toString() {
        return "UsersProfileGetResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", profile=" + this.getProfile() + ")";
    }
}