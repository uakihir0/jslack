...
public class ChannelsSetPurposeResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelsSetPurposeResponse)) return false;
    ...
    public String toString() {
        return "ChannelsSetPurposeResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", purpose=" + this.getPurpose() + ")";
    }
}
