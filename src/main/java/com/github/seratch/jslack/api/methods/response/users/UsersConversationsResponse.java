...
public class UsersConversationsResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "UsersConversationsResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", channels=" + this.getChannels() + ", responseMetadata=" + this.getResponseMetadata() + ")";
    }
}
