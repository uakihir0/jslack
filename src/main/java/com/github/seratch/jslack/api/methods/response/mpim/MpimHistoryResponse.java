...
public class MpimHistoryResponse implements SlackApiResponse {
    ...
    public String toString() {
        return "MpimHistoryResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", latest=" + this.getLatest() + ", messages=" + this.getMessages() + ", hasMore=" + this.isHasMore() + ")";
    }
}