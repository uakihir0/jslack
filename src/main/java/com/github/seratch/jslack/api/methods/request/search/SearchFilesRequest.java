...
public class SearchFilesRequest implements SlackApiRequest {
    ...
    SearchFilesRequest(String token, String query, String sort, String sortDir, Integer highlight, Integer count, Integer page) {
        this.token = token;
        this.query = query;
        this.sort = sort;
    ...
    public String toString() {
        return "SearchFilesRequest(token=" + this.getToken() + ", query=" + this.getQuery() + ", sort=" + this.getSort() + ", sortDir=" + this.getSortDir() + ", highlight=" + this.getHighlight() + ", count=" + this.getCount() + ", page=" + this.getPage() + ")";
    }
    ...
    public static class SearchFilesRequestBuilder {
        ...
        public SearchFilesRequest.SearchFilesRequestBuilder highlight(Integer highlight) {
            this.highlight = highlight;
            return this;
        }
        ...
        public SearchFilesRequest build() {
            return new SearchFilesRequest(token, query, sort, sortDir, highlight, count, page);
        }

        public String toString() {
            return "SearchFilesRequest.SearchFilesRequestBuilder(token=" + this.token + ", query=" + this.query + ", sort=" + this.sort + ", sortDir=" + this.sortDir + ", highlight=" + this.highlight + ", count=" + this.count + ", page=" + this.page + ")";
        }
    }
}