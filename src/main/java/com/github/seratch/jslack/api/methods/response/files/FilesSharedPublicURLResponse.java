...
public class FilesSharedPublicURLResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FilesSharedPublicURLResponse)) return false;
    ...
    public String toString() {
        return "FilesSharedPublicURLResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", file=" + this.getFile() + ", comments=" + this.getComments() + ", paging=" + this.getPaging() + ")";
    }
}