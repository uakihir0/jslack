...
public class OAuthTokenResponse implements SlackApiResponse {
    ...
    public boolean equals(final Object o) {
        ...
        final OAuthTokenResponse other = (OAuthTokenResponse) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof OAuthTokenResponse;
    }
    ...
    public String toString() {
        return "OAuthTokenResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", accessToken=" + this.getAccessToken() + ", scope=" + this.getScope() + ", teamName=" + this.getTeamName() + ", teamId=" + this.getTeamId() + ", userId=" + this.getUserId() + ", incomingWebhook=" + this.getIncomingWebhook() + ", bot=" + this.getBot() + ")";
    }
    ...
    public static class IncomingWebhook {
        ...
        public String toString() {
            return "OAuthTokenResponse.IncomingWebhook(url=" + this.getUrl() + ", channel=" + this.getChannel() + ", channelId=" + this.getChannelId() + ", configurationUrl=" + this.getConfigurationUrl() + ")";
        }
    }
    ...
    public static class Bot {
        ...
        public String toString() {
            return "OAuthTokenResponse.Bot(botUserId=" + this.getBotUserId() + ", botAccessToken=" + this.getBotAccessToken() + ")";
        }
    }
}
