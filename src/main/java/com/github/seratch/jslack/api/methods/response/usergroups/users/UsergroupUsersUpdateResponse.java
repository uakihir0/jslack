...
public class UsergroupUsersUpdateResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsergroupUsersUpdateResponse)) return false;
    ...
    public String toString() {
        return "UsergroupUsersUpdateResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", usergroup=" + this.getUsergroup() + ")";
    }
}