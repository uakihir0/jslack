...
public class TeamIntegrationLogsRequest implements SlackApiRequest {
    ...
    @java.beans.ConstructorProperties({"token", "serviceId", "user", "appId", "changeType", "count", "page"})
    ...
    public String toString() {
        return "TeamIntegrationLogsRequest(token=" + this.getToken() + ", serviceId=" + this.getServiceId() + ", user=" + this.getUser() + ", appId=" + this.getAppId() + ", changeType=" + this.getChangeType() + ", count=" + this.getCount() + ", page=" + this.getPage() + ")";
    }
