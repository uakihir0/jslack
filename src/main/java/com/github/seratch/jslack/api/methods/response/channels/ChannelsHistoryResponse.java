...
public class ChannelsHistoryResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ChannelsHistoryResponse)) return false;
    ...
    public String toString() {
        return "ChannelsHistoryResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", latest=" + this.getLatest() + ", messages=" + this.getMessages() + ", hasMore=" + this.isHasMore() + ")";
    }
}
