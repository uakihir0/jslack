...
public class User {
    ...
    public String toString() {
        return "User(id=" + this.getId() + ", teamId=" + this.getTeamId() + ", name=" + this.getName() + ", deleted=" + this.isDeleted() + ", color=" + this.getColor() + ", realName=" + this.getRealName() + ", tz=" + this.getTz() + ", tzLabel=" + this.getTzLabel() + ", tzOffset=" + this.getTzOffset() + ", profile=" + this.getProfile() + ", admin=" + this.isAdmin() + ", owner=" + this.isOwner() + ", primaryOwner=" + this.isPrimaryOwner() + ", restricted=" + this.isRestricted() + ", ultraRestricted=" + this.isUltraRestricted() + ", bot=" + this.isBot() + ", stranger=" + this.isStranger() + ", appUser=" + this.isAppUser() + ", updated=" + this.getUpdated() + ", has2fa=" + this.isHas2fa() + ", twoFactorType=" + this.getTwoFactorType() + ", hasFiles=" + this.isHasFiles() + ", locale=" + this.getLocale() + ")";
    }
