...
public class UsergroupsCreateRequest implements SlackApiRequest {
    ...
    UsergroupsCreateRequest(String token, String name, String handle, String description, List<String> channels, Integer includeCount) {
        this.token = token;
        this.name = name;
        this.handle = handle;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsergroupsCreateRequest)) return false;
    ...
    public String toString() {
        return "UsergroupsCreateRequest(token=" + this.getToken() + ", name=" + this.getName() + ", handle=" + this.getHandle() + ", description=" + this.getDescription() + ", channels=" + this.getChannels() + ", includeCount=" + this.getIncludeCount() + ")";
    }
    ...
    public static class UsergroupsCreateRequestBuilder {
        ...
        public UsergroupsCreateRequest.UsergroupsCreateRequestBuilder includeCount(Integer includeCount) {
            this.includeCount = includeCount;
            return this;
        }
