...
public class SearchMessagesRequest implements SlackApiRequest {
    ...
    public String toString() {
        return "SearchMessagesRequest(token=" + this.getToken() + ", sortDir=" + this.getSortDir() + ", query=" + this.getQuery() + ", sort=" + this.getSort() + ", highlight=" + this.isHighlight() + ", count=" + this.getCount() + ", page=" + this.getPage() + ")";
    }
