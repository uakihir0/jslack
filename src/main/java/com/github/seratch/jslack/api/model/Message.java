...
public class Message {
    ...
    public static class MessageRoot {
        ...
        public String toString() {
            return "Message.MessageRoot(text=" + this.getText() + ", username=" + this.getUsername() + ", botId=" + this.getBotId() + ", type=" + this.getType() + ", subtype=" + this.getSubtype() + ", threadTs=" + this.getThreadTs() + ", replyCount=" + this.getReplyCount() + ", replies=" + this.getReplies() + ", subscribed=" + this.isSubscribed() + ", unreadCount=" + this.getUnreadCount() + ", ts=" + this.getTs() + ")";
        }
    }
