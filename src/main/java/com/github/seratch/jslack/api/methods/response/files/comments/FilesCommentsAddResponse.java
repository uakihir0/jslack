...
public class FilesCommentsAddResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FilesCommentsAddResponse)) return false;
    ...
    public String toString() {
        return "FilesCommentsAddResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", comment=" + this.getComment() + ")";
    }
}