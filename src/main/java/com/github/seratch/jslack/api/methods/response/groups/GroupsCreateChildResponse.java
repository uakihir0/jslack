...
public class GroupsCreateChildResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GroupsCreateChildResponse)) return false;
    ...
    public String toString() {
        return "GroupsCreateChildResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", group=" + this.getGroup() + ")";
    }
}