...
public class UsergroupsDisableResponse implements SlackApiResponse {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof UsergroupsDisableResponse)) return false;
    ...
    public String toString() {
        return "UsergroupsDisableResponse(ok=" + this.isOk() + ", warning=" + this.getWarning() + ", error=" + this.getError() + ", usergroup=" + this.getUsergroup() + ")";
    }
}