...
public class GroupsLeaveRequest implements SlackApiRequest {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GroupsLeaveRequest)) return false;
        final GroupsLeaveRequest other = (GroupsLeaveRequest) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GroupsLeaveRequest;
    }

    public String toString() {
        return "GroupsLeaveRequest(token=" + this.getToken() + ", channel=" + this.getChannel() + ")";
    }
