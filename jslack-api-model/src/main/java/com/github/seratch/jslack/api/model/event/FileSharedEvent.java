...
public class FileSharedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FileSharedEvent)) return false;
        final FileSharedEvent other = (FileSharedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FileSharedEvent;
    }
    ...
    public String toString() {
        return "FileSharedEvent(type=" + this.getType() + ", fileId=" + this.getFileId() + ", file=" + this.getFile() + ")";
    }
    ...
    public static class File {
        ...
        public String toString() {
            return "FileSharedEvent.File(id=" + this.getId() + ")";
        }
    }
}