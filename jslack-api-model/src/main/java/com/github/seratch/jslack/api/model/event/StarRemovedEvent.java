...
public class StarRemovedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof StarRemovedEvent)) return false;
        final StarRemovedEvent other = (StarRemovedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof StarRemovedEvent;
    }
    ...
    public String toString() {
        return "StarRemovedEvent(type=" + this.getType() + ", user=" + this.getUser() + ", item=" + this.getItem() + ", eventTs=" + this.getEventTs() + ")";
    }
    ...
    public static class Item {
        ...
        public String toString() {
            return "StarRemovedEvent.Item(type=" + this.getType() + ", channel=" + this.getChannel() + ", createdBy=" + this.getCreatedBy() + ", created=" + this.getCreated() + ", message=" + this.getMessage() + ", file=" + this.getFile() + ", comment=" + this.getComment() + ")";
        }
    }
    ...
    public static class Message {
        ...
        public String toString() {
            return "StarRemovedEvent.Message(clientMsgId=" + this.getClientMsgId() + ", type=" + this.getType() + ", user=" + this.getUser() + ", text=" + this.getText() + ", blocks=" + this.getBlocks() + ", attachments=" + this.getAttachments() + ", ts=" + this.getTs() + ", pinnedTo=" + this.getPinnedTo() + ", permalink=" + this.getPermalink() + ")";
        }
    }
