...
public class ReactionRemovedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ReactionRemovedEvent)) return false;
        final ReactionRemovedEvent other = (ReactionRemovedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ReactionRemovedEvent;
    }
    ...
    public String toString() {
        return "ReactionRemovedEvent(type=" + this.getType() + ", user=" + this.getUser() + ", reaction=" + this.getReaction() + ", itemUser=" + this.getItemUser() + ", item=" + this.getItem() + ", eventTs=" + this.getEventTs() + ")";
    }
    ...
    public static class Item {
        ...
        public String toString() {
            return "ReactionRemovedEvent.Item(type=" + this.getType() + ", channel=" + this.getChannel() + ", ts=" + this.getTs() + ", file=" + this.getFile() + ", fileComment=" + this.getFileComment() + ")";
        }
    }
}