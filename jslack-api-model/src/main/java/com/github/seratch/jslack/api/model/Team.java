...
public class Team {
    ...
    public static class Profile {
        ...
        public String toString() {
            return "Team.Profile(id=" + this.getId() + ", fieldName=" + this.getFieldName() + ", ordering=" + this.getOrdering() + ", label=" + this.getLabel() + ", hint=" + this.getHint() + ", type=" + this.getType() + ", possibleValues=" + this.getPossibleValues() + ", options=" + this.getOptions() + ", hidden=" + this.isHidden() + ")";
        }
    }
