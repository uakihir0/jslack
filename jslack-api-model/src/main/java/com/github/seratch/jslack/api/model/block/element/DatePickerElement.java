...
public class DatePickerElement extends BlockElement {
    ...
    public String toString() {
        return "DatePickerElement(type=" + this.getType() + ", fallback=" + this.getFallback() + ", actionId=" + this.getActionId() + ", placeholder=" + this.getPlaceholder() + ", initialDate=" + this.getInitialDate() + ", confirm=" + this.getConfirm() + ")";
    }
