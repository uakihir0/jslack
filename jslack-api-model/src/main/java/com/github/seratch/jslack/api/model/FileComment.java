...
public class FileComment {
    ...
    public String toString() {
        return "FileComment(id=" + this.getId() + ", created=" + this.getCreated() + ", timestamp=" + this.getTimestamp() + ", user=" + this.getUser() + ", comment=" + this.getComment() + ", channel=" + this.getChannel() + ", intro=" + this.isIntro() + ")";
    }
