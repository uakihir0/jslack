...
public class BotAddedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof BotAddedEvent)) return false;
        final BotAddedEvent other = (BotAddedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof BotAddedEvent;
    }
    ...
    public String toString() {
        return "BotAddedEvent(type=" + this.getType() + ", bot=" + this.getBot() + ")";
    }
    ...
    public static class Bot {
        ...
        public String toString() {
            return "BotAddedEvent.Bot(id=" + this.getId() + ", appId=" + this.getAppId() + ", name=" + this.getName() + ", icons=" + this.getIcons() + ")";
        }
    }
