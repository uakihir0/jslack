...
public class TeamProfileDeleteEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TeamProfileDeleteEvent)) return false;
        final TeamProfileDeleteEvent other = (TeamProfileDeleteEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof TeamProfileDeleteEvent;
    }
    ...
    public String toString() {
        return "TeamProfileDeleteEvent(type=" + this.getType() + ", profile=" + this.getProfile() + ")";
    }
    ...
    public static class Profile {
        ...
        public String toString() {
            return "TeamProfileDeleteEvent.Profile(fields=" + this.getFields() + ")";
        }
    }
    ...
    public static class Field {
        ...
        public String toString() {
            return "TeamProfileDeleteEvent.Field(id=" + this.getId() + ")";
        }
