...
public class Usergroup {
    ...
    Usergroup(String id, String teamId, String enterpriseSubteamId, boolean usergroup, boolean subteam, String name, String description, String handle, boolean external, boolean autoProvision, Integer dateCreate, Integer dateUpdate, Integer dateDelete, String autoType, String createdBy, String updatedBy, String deletedBy, Prefs prefs, List<String> users, Integer userCount) {
        this.id = id;
        this.teamId = teamId;
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$enterpriseSubteamId = this.getEnterpriseSubteamId();
        final Object other$enterpriseSubteamId = other.getEnterpriseSubteamId();
        if (this$enterpriseSubteamId == null ? other$enterpriseSubteamId != null : !this$enterpriseSubteamId.equals(other$enterpriseSubteamId))
            return false;
        if (this.isUsergroup() != other.isUsergroup()) return false;
        if (this.isSubteam() != other.isSubteam()) return false;
        ...
        if (this.isAutoProvision() != other.isAutoProvision()) return false;
    ...
    public int hashCode() {
        ...
        final Object $enterpriseSubteamId = this.getEnterpriseSubteamId();
        result = result * PRIME + ($enterpriseSubteamId == null ? 43 : $enterpriseSubteamId.hashCode());
        result = result * PRIME + (this.isUsergroup() ? 79 : 97);
        result = result * PRIME + (this.isSubteam() ? 79 : 97);
        ...
        result = result * PRIME + (this.isAutoProvision() ? 79 : 97);
    ...
    public String toString() {
        return "Usergroup(id=" + this.getId() + ", teamId=" + this.getTeamId() + ", enterpriseSubteamId=" + this.getEnterpriseSubteamId() + ", usergroup=" + this.isUsergroup() + ", subteam=" + this.isSubteam() + ", name=" + this.getName() + ", description=" + this.getDescription() + ", handle=" + this.getHandle() + ", external=" + this.isExternal() + ", autoProvision=" + this.isAutoProvision() + ", dateCreate=" + this.getDateCreate() + ", dateUpdate=" + this.getDateUpdate() + ", dateDelete=" + this.getDateDelete() + ", autoType=" + this.getAutoType() + ", createdBy=" + this.getCreatedBy() + ", updatedBy=" + this.getUpdatedBy() + ", deletedBy=" + this.getDeletedBy() + ", prefs=" + this.getPrefs() + ", users=" + this.getUsers() + ", userCount=" + this.getUserCount() + ")";
    }
