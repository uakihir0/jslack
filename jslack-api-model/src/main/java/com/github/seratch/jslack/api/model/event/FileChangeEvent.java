...
public class FileChangeEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        final FileChangeEvent other = (FileChangeEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FileChangeEvent;
    }
    ...
    public String toString() {
        return "FileChangeEvent(type=" + this.getType() + ", fileId=" + this.getFileId() + ", file=" + this.getFile() + ")";
    }
    ...
    public static class File {
        ...
        public String toString() {
            return "FileChangeEvent.File(id=" + this.getId() + ")";
        }
    }
}