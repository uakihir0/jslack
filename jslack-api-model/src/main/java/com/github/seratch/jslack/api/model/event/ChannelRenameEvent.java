...
public class ChannelRenameEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelRenameEvent)) return false;
        final ChannelRenameEvent other = (ChannelRenameEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelRenameEvent;
    }
    ...
    public String toString() {
        return "ChannelRenameEvent(type=" + this.getType() + ", channel=" + this.getChannel() + ")";
    }
    ...
    public static class Channel {
        ...
        public String toString() {
            return "ChannelRenameEvent.Channel(id=" + this.getId() + ", name=" + this.getName() + ", created=" + this.getCreated() + ")";
        }
    }
}