...
public class FileUnsharedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FileUnsharedEvent)) return false;
        final FileUnsharedEvent other = (FileUnsharedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FileUnsharedEvent;
    }
    ...
    public String toString() {
        return "FileUnsharedEvent(type=" + this.getType() + ", fileId=" + this.getFileId() + ", file=" + this.getFile() + ")";
    }
    ...
    public static class File {
        ...
        public String toString() {
            return "FileUnsharedEvent.File(id=" + this.getId() + ")";
        }
    }
}