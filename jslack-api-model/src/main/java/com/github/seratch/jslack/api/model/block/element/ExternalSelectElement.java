...
public class ExternalSelectElement extends BlockElement {
    ...
    public String toString() {
        return "ExternalSelectElement(type=" + this.getType() + ", fallback=" + this.getFallback() + ", placeholder=" + this.getPlaceholder() + ", actionId=" + this.getActionId() + ", initialOption=" + this.getInitialOption() + ", minQueryLength=" + this.getMinQueryLength() + ", confirm=" + this.getConfirm() + ")";
    }
