...
public class Conversation {
    ...
    public boolean equals(final Object o) {
        ...
        final Object this$sharedTeamIds = this.getSharedTeamIds();
        final Object other$sharedTeamIds = other.getSharedTeamIds();
        if (this$sharedTeamIds == null ? other$sharedTeamIds != null : !this$sharedTeamIds.equals(other$sharedTeamIds))
            return false;
        final Object this$parentConversation = this.getParentConversation();
        final Object other$parentConversation = other.getParentConversation();
        if (this$parentConversation == null ? other$parentConversation != null : !this$parentConversation.equals(other$parentConversation))
            return false;
        final Object this$pendingConnectedTeamIds = this.getPendingConnectedTeamIds();
        final Object other$pendingConnectedTeamIds = other.getPendingConnectedTeamIds();
        if (this$pendingConnectedTeamIds == null ? other$pendingConnectedTeamIds != null : !this$pendingConnectedTeamIds.equals(other$pendingConnectedTeamIds))
            return false;
        final Object this$conversationHostId = this.getConversationHostId();
        final Object other$conversationHostId = other.getConversationHostId();
        if (this$conversationHostId == null ? other$conversationHostId != null : !this$conversationHostId.equals(other$conversationHostId))
            return false;
        ...
        if (this.isMoved() != other.isMoved()) return false;
    ...
    public int hashCode() {
        ...
        final Object $sharedTeamIds = this.getSharedTeamIds();
        result = result * PRIME + ($sharedTeamIds == null ? 43 : $sharedTeamIds.hashCode());
        final Object $parentConversation = this.getParentConversation();
        result = result * PRIME + ($parentConversation == null ? 43 : $parentConversation.hashCode());
        final Object $pendingConnectedTeamIds = this.getPendingConnectedTeamIds();
        result = result * PRIME + ($pendingConnectedTeamIds == null ? 43 : $pendingConnectedTeamIds.hashCode());
        final Object $conversationHostId = this.getConversationHostId();
        result = result * PRIME + ($conversationHostId == null ? 43 : $conversationHostId.hashCode());
        ...
        result = result * PRIME + (this.isMoved() ? 79 : 97);
    ...
    public String toString() {
        return "Conversation(id=" + this.getId() + ", name=" + this.getName() + ", created=" + this.getCreated() + ", creator=" + this.getCreator() + ", unlinked=" + this.getUnlinked() + ", nameNormalized=" + this.getNameNormalized() + ", pendingShared=" + this.getPendingShared() + ", lastRead=" + this.getLastRead() + ", topic=" + this.getTopic() + ", purpose=" + this.getPurpose() + ", previousNames=" + this.getPreviousNames() + ", numOfMembers=" + this.getNumOfMembers() + ", members=" + this.getMembers() + ", latest=" + this.getLatest() + ", locale=" + this.getLocale() + ", unreadCount=" + this.getUnreadCount() + ", unreadCountDisplay=" + this.getUnreadCountDisplay() + ", user=" + this.getUser() + ", priority=" + this.getPriority() + ", sharedTeamIds=" + this.getSharedTeamIds() + ", parentConversation=" + this.getParentConversation() + ", pendingConnectedTeamIds=" + this.getPendingConnectedTeamIds() + ", conversationHostId=" + this.getConversationHostId() + ", isChannel=" + this.isChannel() + ", isGroup=" + this.isGroup() + ", isIm=" + this.isIm() + ", isArchived=" + this.isArchived() + ", isGeneral=" + this.isGeneral() + ", isReadOnly=" + this.isReadOnly() + ", isShared=" + this.isShared() + ", isExtShared=" + this.isExtShared() + ", isOrgShared=" + this.isOrgShared() + ", isPendingExtShared=" + this.isPendingExtShared() + ", isMoved=" + this.isMoved() + ", isMember=" + this.isMember() + ", open=" + this.isOpen() + ", isPrivate=" + this.isPrivate() + ", isMpim=" + this.isMpim() + ")";
    }
    ...
    public static class ConversationBuilder {
        ...
        public Conversation.ConversationBuilder isMoved(boolean isMoved) {
            this.isMoved = isMoved;
            return this;
        }
