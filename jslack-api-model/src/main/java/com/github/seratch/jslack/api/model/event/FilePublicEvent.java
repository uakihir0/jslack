...
public class FilePublicEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FilePublicEvent)) return false;
        final FilePublicEvent other = (FilePublicEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FilePublicEvent;
    }
    ...
    public String toString() {
        return "FilePublicEvent(type=" + this.getType() + ", fileId=" + this.getFileId() + ", file=" + this.getFile() + ")";
    }
    ...
    public static class File {
        ...
        public String toString() {
            return "FilePublicEvent.File(id=" + this.getId() + ")";
        }
    }
}