...
public class SubteamUpdatedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof SubteamUpdatedEvent)) return false;
        final SubteamUpdatedEvent other = (SubteamUpdatedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof SubteamUpdatedEvent;
    }
    ...
    public String toString() {
        return "SubteamUpdatedEvent(type=" + this.getType() + ", subteam=" + this.getSubteam() + ")";
    }
    ...
    public static class Prefs {
        ...
        public String toString() {
            return "SubteamUpdatedEvent.Prefs(channels=" + this.getChannels() + ", groups=" + this.getGroups() + ")";
        }
    }
