...
public class ChannelUnarchiveEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ChannelUnarchiveEvent)) return false;
        final ChannelUnarchiveEvent other = (ChannelUnarchiveEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ChannelUnarchiveEvent;
    }
    ...
    public String toString() {
        return "ChannelUnarchiveEvent(type=" + this.getType() + ", channel=" + this.getChannel() + ", user=" + this.getUser() + ")";
    }
}