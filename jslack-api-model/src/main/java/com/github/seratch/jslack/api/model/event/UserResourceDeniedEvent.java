...
public class UserResourceDeniedEvent implements Event {
    ...
    public UserResourceDeniedEvent() {
    }
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UserResourceDeniedEvent)) return false;
        final UserResourceDeniedEvent other = (UserResourceDeniedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UserResourceDeniedEvent;
    }
    ...
    public String toString() {
        return "UserResourceDeniedEvent(type=" + this.getType() + ", user=" + this.getUser() + ", scopes=" + this.getScopes() + ", triggerId=" + this.getTriggerId() + ")";
    }
}