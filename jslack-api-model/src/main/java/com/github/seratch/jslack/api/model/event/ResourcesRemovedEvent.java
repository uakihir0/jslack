...
public class ResourcesRemovedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof ResourcesRemovedEvent)) return false;
        final ResourcesRemovedEvent other = (ResourcesRemovedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ResourcesRemovedEvent;
    }
    ...
    public String toString() {
        return "ResourcesRemovedEvent(type=" + this.getType() + ", resources=" + this.getResources() + ")";
    }
    ...
    public static class ResourceItem {
        ...
        public String toString() {
            return "ResourcesRemovedEvent.ResourceItem(resource=" + this.getResource() + ", scopes=" + this.getScopes() + ")";
        }
    }
    ...
    public static class Resource {
        ...
        public String toString() {
            return "ResourcesRemovedEvent.Resource(type=" + this.getType() + ", grant=" + this.getGrant() + ")";
        }
    }
    ...
    public static class Grant {
        ...
        public String toString() {
            return "ResourcesRemovedEvent.Grant(type=" + this.getType() + ", resourceId=" + this.getResourceId() + ")";
        }
    }
