...
public class UsersSelectElement extends BlockElement {
    ...
    public String toString() {
        return "UsersSelectElement(type=" + this.getType() + ", fallback=" + this.getFallback() + ", placeholder=" + this.getPlaceholder() + ", actionId=" + this.getActionId() + ", initialUser=" + this.getInitialUser() + ", confirm=" + this.getConfirm() + ")";
    }
