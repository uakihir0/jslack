...
public class PinRemovedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof PinRemovedEvent)) return false;
        final PinRemovedEvent other = (PinRemovedEvent) o;
        ...
        if (this.isHasPins() != other.isHasPins()) return false;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof PinRemovedEvent;
    }
    ...
    public int hashCode() {
        ...
        result = result * PRIME + (this.isHasPins() ? 79 : 97);
    ...
    public String toString() {
        return "PinRemovedEvent(type=" + this.getType() + ", user=" + this.getUser() + ", channelId=" + this.getChannelId() + ", item=" + this.getItem() + ", hasPins=" + this.isHasPins() + ", eventTs=" + this.getEventTs() + ")";
    }
    ...
    public static class Item {
        ...
        public String toString() {
            return "PinRemovedEvent.Item(type=" + this.getType() + ", channel=" + this.getChannel() + ", createdBy=" + this.getCreatedBy() + ", created=" + this.getCreated() + ", message=" + this.getMessage() + ", file=" + this.getFile() + ", comment=" + this.getComment() + ")";
        }
    }
    ...
    public static class Message {
        ...
        public String toString() {
            return "PinRemovedEvent.Message(clientMsgId=" + this.getClientMsgId() + ", type=" + this.getType() + ", user=" + this.getUser() + ", text=" + this.getText() + ", blocks=" + this.getBlocks() + ", attachments=" + this.getAttachments() + ", ts=" + this.getTs() + ", pinnedTo=" + this.getPinnedTo() + ", permalink=" + this.getPermalink() + ")";
        }
    }
}