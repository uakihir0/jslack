...
public class FileCommentAddedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof FileCommentAddedEvent)) return false;
        final FileCommentAddedEvent other = (FileCommentAddedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof FileCommentAddedEvent;
    }
    ...
    public String toString() {
        return "FileCommentAddedEvent(type=" + this.getType() + ", comment=" + this.getComment() + ", fileId=" + this.getFileId() + ", file=" + this.getFile() + ")";
    }
    ...
    public static class FileComment {
        ...
        public String toString() {
            return "FileCommentAddedEvent.FileComment()";
        }
    }
    ...
    public static class File {
        ...
        public String toString() {
            return "FileCommentAddedEvent.File(id=" + this.getId() + ")";
        }
    }
}