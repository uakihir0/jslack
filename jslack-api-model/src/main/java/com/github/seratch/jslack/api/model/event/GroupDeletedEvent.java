...
public class GroupDeletedEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupDeletedEvent)) return false;
        final GroupDeletedEvent other = (GroupDeletedEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupDeletedEvent;
    }
    ...
    public String toString() {
        return "GroupDeletedEvent(type=" + this.getType() + ", channel=" + this.getChannel() + ")";
    }
}