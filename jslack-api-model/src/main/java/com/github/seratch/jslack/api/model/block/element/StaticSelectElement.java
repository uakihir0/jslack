...
public class StaticSelectElement extends BlockElement {
    ...
    public String toString() {
        return "StaticSelectElement(type=" + this.getType() + ", fallback=" + this.getFallback() + ", placeholder=" + this.getPlaceholder() + ", actionId=" + this.getActionId() + ", options=" + this.getOptions() + ", optionGroups=" + this.getOptionGroups() + ", initialOption=" + this.getInitialOption() + ", confirm=" + this.getConfirm() + ")";
    }
