...
public class GroupArchiveEvent implements Event {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof GroupArchiveEvent)) return false;
        final GroupArchiveEvent other = (GroupArchiveEvent) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof GroupArchiveEvent;
    }
    ...
    public String toString() {
        return "GroupArchiveEvent(type=" + this.getType() + ", channel=" + this.getChannel() + ")";
    }
}